...
la interfaz y este archivo actúa como orquestador; la lógica funcional vive en
core, integrations, providers, extraction y export.
"""
...
st.caption("Streamlit → Gemini → Excel/PDF → Azure DevOps")

...
def format_description_for_azure(description):
    ...
    # Corrige escapes literales que pueda devolver el modelo.
    # El resultado debe contener saltos de línea REALES, nunca la cadena literal \n.
    text = text.replace(r"\n", "\n").replace(r"\r\n", "\n")

    # Nunca usamos pipes como separadores de bloques.
    text = re.sub(r"\s*\|\s*", "\n\n", text)
